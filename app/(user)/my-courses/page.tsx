                        ...
                        {coursesWithProgress.map((item) => {
                            ...
                            return (
                                <CourseCard
                                    ...
                                    course={{
                                        ...item.course,
                                        image: item.course.image?.asset?._ref || undefined,
                                        category: item.course.category ? { name: item.course.category.name } : undefined,
                                        instructor: item.course.instructor
                                            ? {
                                                name: item.course.instructor.name || undefined,
                                                photo: item.course.instructor.photo?.asset?._ref || undefined,
                                            }
                                            : undefined,
                                    }}
