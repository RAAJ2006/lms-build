                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {courses.map((course) => (
                            <CourseCard
                                ...
                                course={{
                                    ...course,
                                    image: course.image?.asset?._ref || undefined,
                                    category: course.category ? { name: course.category.name } : undefined,
                                    instructor: course.instructor
                                        ? {
                                            name: course.instructor.name || undefined,
                                            photo: course.instructor.photo?.asset?._ref || undefined,
                                        }
                                        : undefined,
                                }}
